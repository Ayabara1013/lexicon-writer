  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      Typography.configure({
        ...(typo.curlyQuotes ? {} : { openDoubleQuote: false, closeDoubleQuote: false, openSingleQuote: false, closeSingleQuote: false }),
        ...(typo.emDash    ? {} : { emDash: false }),
        ...(typo.ellipsis  ? {} : { ellipsis: false }),
